...
const LinkedInIcon = ({width='100', height='100', color='currentColor'}: Props) => {
  return (
    <svg fill={color} height={height} width={width} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" 
