  ...
  return (
    <Section id={'About'} title={'About Me'}>
      ...
      >
        ...
        <p>As a Software Engineer Intern at Intel, I'm refactoring an automation framework and debugging platform issues. Previously, I built key mobile app features as a Frontend Developer at an early-stage startup.</p>
